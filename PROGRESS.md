...
- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3539 → 3541. Total na BD: 3541.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, pares fuzzy (≥0.9) fora de BANDEIRAS, pares de famílias de template ignorados. Total na BD: 3541.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT FIXES**: Corrigidos 3 ficheiros — `global.d.ts` (any→Record), `tts.ts` (reject unused), `achievements/page.tsx` (Lock unused). Erros reduzidos de 56→54.
...
## [2026-09-15] Ciclo de Manutenção (71º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3532 → 3534. Total na BD: 3532.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 495 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.740 pares de famílias de template ignorados. Total na BD: 3532.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-15] Ciclo de Manutenção (70º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3530 → 3532. Total na BD: 3532.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 495 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.740 pares de famílias de template ignorados. Total na BD: 3532.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-15] Ciclo de Manutenção (69º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3525 → 3527. Total na BD: 3530.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 494 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.736 pares de famílias de template ignorados. Total na BD: 3530.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-15] Ciclo de Manutenção (68º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3523 → 3525. Total na BD: 3525.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 461 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.725 pares de famílias de template ignorados. Total na BD: 3525.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-15] Ciclo de Manutenção (67º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3521 → 3523. Total na BD: 3.521.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 457 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.722 pares de famílias de template ignorados. Total na BD: 3.521.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-14] Ciclo de Manutenção (66º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3519 → 3521. Total na BD: 3.521.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 456 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.716 pares de famílias de template ignorados. Total na BD: 3.521.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-14] Ciclo de Manutenção (65º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3517 → 3519. Total na BD: 3.519.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 456 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.716 pares de famílias de template ignorados. Total na BD: 3.519.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.

## [2026-09-14] Ciclo de Manutenção (64º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3512 → 3514. Total na BD: 3.515.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 30 grupos aproximados, 453 pares fuzzy (≥0.9) fora de BANDEIRAS, 1.715 pares de famílias de template ignorados. Total na BD: 3.515.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` 40/40 páginas OK.
...
- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3506 → 3508. Total na BD: 3.508.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 443 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.711 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.508.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-14] Ciclo de Manutenção (60º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3504 → 3506. Total na BD: 3.506.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 435 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.709 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.506.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-14] Ciclo de Manutenção (59º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3500 → 3502. Total na BD: 3.502.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 433 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.709 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.502.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-14] Ciclo de Manutenção (58º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3498 → 3500. Total na BD: 3.500.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 425 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.704 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.500.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-14] Ciclo de Manutenção (57º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3491 → 3493. Total na BD: 3.493.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **45 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 422 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.759 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.493.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-14] Ciclo de Manutenção (56º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3489 → 3491. Total na BD: 3.491.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 418 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.695 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.491.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-14] Ciclo de Manutenção (55º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3487 → 3489. Total na BD: 3.489.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 418 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.694 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.489.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-13] Ciclo de Manutenção (53º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3483 → 3485. Total na BD: 3.485.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 409 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.685 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.485.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-13] Ciclo de Manutenção (52º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3478 → 3480. Total na BD: 3.483.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 384 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.679 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.483.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-13] Ciclo de Manutenção (51º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3476 → 3478. Total na BD: 3.478.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 379 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.674 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.478.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-13] Ciclo de Manutenção (50º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3472 → 3474. Total na BD: 3.474.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 377 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.663 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.474.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-13] Ciclo de Manutenção (49º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3470 → 3472. Total na BD: 3.472.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 377 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.662 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.472.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-12] Ciclo de Manutenção (47º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3468 → 3470. Total na BD: 3.470.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 375 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.660 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.470.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-12] Ciclo de Manutenção (46º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3466 → 3468. Total na BD: 3.468.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 375 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.660 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.468.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-12] Ciclo de Manutenção (45º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3458 → 3460. Total na BD: 3.460.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 373 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.658 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.460.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-11] Ciclo de Manutenção (44º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3456 → 3458. Total na BD: 3.458.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 367 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.656 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.458.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-10] Ciclo de Manutenção (43º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3454 → 3456. Total na BD: 3.456.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 363 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.653 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.456.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-10] Ciclo de Manutenção (41º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3450 → 3452. Total na BD: 3.452.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 356 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.649 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.452.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-10] Ciclo de Manutenção (40º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3445 → 3447. Total na BD: 3.450.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 352 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.649 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.450.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-10] Ciclo de Manutenção (39º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3443 → 3445. Total na BD: 3.445.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 326 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.646 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.445.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-10] Ciclo de Manutenção (38º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3441 → 3443. Total na BD: 3.443.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 324 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.644 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.443.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-09] Ciclo de Manutenção (37º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3439 → 3441. Total na BD: 3.441.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 324 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.636 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.441.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-09] Ciclo de Manutenção (36º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3437 → 3439. Total na BD: 3.439.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 305 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.628 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.439.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-09] Ciclo de Manutenção (35º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3432 → 3434. Total na BD: 3.437.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 305 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.628 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.437.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-09] Ciclo de Manutenção (34º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3430 → 3432. Total na BD: 3.432.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 283 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.626 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.432.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-08] Ciclo de Manutenção (33º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3428 → 3430. Total na BD: 3.430.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 281 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.625 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.430.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-08] Ciclo de Manutenção (32º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3426 → 3428. Total na BD: 3.428.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 281 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.625 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.428.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-08] Ciclo de Manutenção (31º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3421 → 3423. Total na BD: 3.423.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 275 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.621 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.423.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-08] Ciclo de Manutenção (30º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3419 → 3421. Total na BD: 3.421.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 273 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.620 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.421.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-08] Ciclo de Manutenção (29º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3417 → 3419. Total na BD: 3.419.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 256 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.618 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.419.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-07] Ciclo de Manutenção (28º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3415 → 3417. Total na BD: 3.417.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 254 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.617 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.417.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-07] Ciclo de Manutenção (27º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3413 → 3415. Total na BD: 3.415.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 238 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.613 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.415.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-07] Ciclo de Manutenção (26º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3408 → 3410. Total na BD: 3.410.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 228 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.599 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.410.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-07] Ciclo de Manutenção (25º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3406 → 3408. Total na BD: 3.408.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 226 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.596 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.408.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-06] Ciclo de Manutenção (24º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3404 → 3406. Total na BD: 3.406.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 210 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.594 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.406.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-06] Ciclo de Manutenção (23º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3402 → 3404. Total na BD: 3.404.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 210 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.594 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.404.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-06] Ciclo de Manutenção (22º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3397 → 3399. Total na BD: 3.402.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 208 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.592 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.402.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-06] Ciclo de Manutenção (21º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3395 → 3397. Total na BD: 3.397.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 185 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.590 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.397.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-06] Ciclo de Manutenção (20º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3393 → 3395. Total na BD: 3.395.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 184 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.590 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.395.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-05] Ciclo de Manutenção (19º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3391 → 3393. Total na BD: 3.393.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 182 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.590 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.393.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-05] Ciclo de Manutenção (18º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3389 → 3391. Total na BD: 3.391.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 168 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.588 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.391.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.

## [2026-09-05] Ciclo de Manutenção (17º ciclo, 8h) — Novas Perguntas + Dedupe Semanal

- **TAREFA DIÁRIA — Novas perguntas**: `npm run daily` → **+2 novas** via built-in (MATEMATICA). Backup: 3384 → 3386. Total na BD: 3.389.
  - `questions_backup.json` atualizado automaticamente pelo script.
- **TAREFA SEMANAL — Duplicados**: `scripts/weekly-dedupe.mjs` → **0 duplicados exatos removidos**. 27 grupos aproximados (texto+categoria), 166 pares fuzzy (≥0.9) reais fora de BANDEIRAS, 1.585 pares de famílias de template ignorados como falsos positivos. Total na BD: 3.389.
  - Relatório gravado em `scripts/dedupe-report.json`.
- **LINT/BUILD/TESTS**: `npm test` 15/15 passaram; `npm run build` gerou 40/40 páginas estáticas e rotas dinâmicas sem erros.
