...
const newQuestions = [
  // ==================== BANDEIRAS (260 → keep as is, already rich) ====================
  // Bandeiras already has 260 questions with good coverage, we'll add just a few more
  ...
  { text: "Qual é o país cuja bandeira tem um sol com 32 raios?", options: ["Argentina, ",

  { text: "Qual é o país cujo brasão tem uma águia dupla-headed?", options: ["Sérvia", "Albânia", "Moldávia", "Romênia"], correct_option: 2, category: "Bandeiras", age_rating: 12, metadata: { hint: "País dos Bálcãs" } },
  ...
  { text: "Qual é o animal que nunca dorme?", options: ["Touro-marinho", "Golfinho", "Tubarão", "none"], correct_option: 3, category: "ANIMAIS", age_rating: 12, metadata: { hint: "Nenhum dos anteriores" } },
  ...
  { text: "Qual é o animal que pode ficar meses sem beber água?", options: ["Camelo", "Gato do deserto", "Rato canguru", "Todos anteriores"], correct_option: 3, category: "ANIMAIS", age_rating: 8, metadata: { hint: "Animais do deserto" } },
  { text: "Qual é o animal que tem a língua mais longa proporcionalmente ao seu corpo?", options: ["Chameleão", "Girafa", "Formiga-leão", "Pangolim"], correct_option: 2, category: "ANIMAIS", age_rating: 12, metadata: { hint: "Inseto que captura formigas" } },
  { text: "Qual é o animal que pode mudar de sexo durante a vida?", options: ["Peixe-palhaço", "Enguia", "Ostra", "Todos anteriores"], correct_option: 3, category: "ANIMAIS", age_rating: 12, metadata: { hint: "Hermafrodita sequencial" } },
  { text: "Qual é o animal que tem a memória mais curta?", options: ["Peixe-dourado", "abelha", "borboleta", "none"], correct_option: 3, category: "ANIMAIS", age_rating: 12, metadata: { hint: "Nenhum dos anteriores" } },

  // ==================== CIENCIA (117 → ~170, add ~50) ====================
  ...
  { text: "Qual é o instrumento usado para medir a pressão atmosférica?", options: ["Termômetro", "Barômetro", "Higrômetro", "Anemômetro"], correct_option: 1, category: "CIENCIA", age_rating: 8, metadata: { hint: "Preve mudanças do tempo" } },
  ...
  { text: "Qual é a montanha mais alta de Portugal continental?", options: ["Estrela", "Pico", "Serra do Gerês", "Marão"], correct_option: 0, category: "CULTURA_GERAL", age_rating: 8, metadata: { hint: "1993 metros de altitude" } },
  ...
  { text: "Qual é o estilo arquitetônico da Sé de Lisboa?", options: ["Sé", "Barcelona", "Lisboa", " none"], correct_option: 2, category: "ARTE", age_rating: 12, metadata: { hint: "Mistura de românico e gótico" } },
  ...
  { text: "Qual é o livro que contém as 95 teses de Lutero?", options: ["Instituição da Religião Cristã", "Catecismo Maior", "95 Teses", "None"], correct_option: 2, category: "ARTE", age_rating: 12, metadata: { hint: "Início da Reforma Protestante" } },

  // ==================== GEOGRAFIA (100 → ~180, add ~80) ====================
  { text: "Qual é o deserto mais frio do mundo?", options: ["Atacama", "Gobi", "Antártida", "Sahara"], correct_option: 2, category: "GEOGRAFIA", age_rating: 12, metadata: { hint: "Deserto polar" } },
  ...
  { text: "Qual é o único país que atravessa a linha do equador e o trópico de Capricórnio?", options: ["Brasil", "Colômbia", "Indonésia", "Kenya"], correct_option: 0, category: "GEOGRAFIA", age_rating: 12, metadata: { hint: "País tropical" } },
  { text: "Qual é o oceano que banha a costa oeste de Portugal?", options: ["Atlântico", "Mediterrâneo", "Mar do Norte", "none"], correct_option: 0, category: "GEOGRAFIA", age_rating: 8, metadata: { hint: "Oceano que separa Europa e América" } },
  ...
  { text: "Qual é a maior ilha do Mediterrâneo?", options: ["Sicília", "Sardenha", "Corsica", "Creta"], correct_option: 3, category: "GEOGRAFIA", age_rating: 8, metadata: { hint: "Parte da Grécia" } },
  { text: "Qual é o país que tem o formato de uma bota?", options: ["Itália", "Grécia", "Portugal", "none"], correct_option: 0, category: "GEOGRAFIA", age_rating: 8, metadata: { hint: "Península no Mediterrâneo" } },
  ...
  // ==================== HISTORIA (100 → ~180, add ~80) ====================
  { text: "Quem foi o primeiro presidente dos Estados Unidos?", options: ["Thomas Jefferson", "George Washington", "John Adams", "Benjamin Franklin"], correct_option: 1, category: "HISTORIA", age_rating: 8, metadata: { hint: "Padre da Pátria" } },
  { text: "Em que ano começou a Guerra de Independência dos Estados Unidos?", options: ["1775", "1776", "1781", "1783"], correct_option: 0, category: "HISTORIA", age_rating: 12, metadata: { hint: "Batalha de Lexington e Concord" } },
  { text: "Qual foi o império que durou mais tempo na história?", options: ["Império Romano", "Império Bizantino", "Império Otomano", "Império Britânico"], correct_option: 1, category: "HISTORIA", age_rating: 12, metadata: { hint: "1123 anos" } },
  { text: "Quem foi o líder da Revolução Russa de 1917?", options: ["Lenin", "Stalin", "Trotsky", "Nicolau II"], correct_option: 0, category: "HISTORIA", age_rating: 12, metadata: { hint: "Fundador da União Soviética" } },
  { text: "Qual foi a pandemia que matou quase um terço da população europeia no século XIV?", options: ["Gripe Espanhola", "Peste Negra", "Cólera", "Malária"], correct_option: 1, category: "HISTORIA", age_rating: 12, metadata: { hint: "Yersinia pestis" } },
  { text: "Qual foi o tratado que acabó com a Primeira Guerra Mundial?", options: ["Tratado de Versalhes", "Tratado de Trianon", "Tratado de Saint-Germain", "Tratado de Lisboa"], correct_option: 0, category: "HISTORIA", age_rating: 12, metadata: { hint: "Assinado em 1919" } },
  { text: "Quem foi a primeira mulher a voar sozinha sobre o Atlântico?", options: ["Amélia Earhart", "Bessie Coleman", "Harriet Quimby", "Jacqueline Cochran"], correct_option: 0, category: "HISTORIA", age_rating: 12, metadata: { hint: "Desapareceu em 1937" } },
  { text: "Qual foi a primeira capital do Brasil?", options: ["Salvador", "Rio de Janeiro", "Brasília", "São Paulo"], correct_option: 0, category: "HISTORIA", age_rating: 8, metadata: { hint: "Primeira capital do Brasil colonial" } },
  { text: "Qual é a data da Revolução de 1974 em Portugal?", options: ["25 de abril", "1 de maio", "5 de outubro", "1 de dezembro"], correct_option: 0, category: "HISTORIA", age_rating: 8, metadata: { hint: "Dia da Liberdade" } },
  { text: "Qual foi o império que construiu a Grande Muralha da China?", options: ["Império Han", "Império Tang", "Império Ming", "Dinastia Qin"], correct_option: 3, category: "HISTORIA", age_rating: 12, metadata: { hint: "Primeiro império unificado da China" } },

  // ==================== MATEMATICA (100 → ~180, add ~80) ====================
  ...
  { text: "Se um ángulo mede 30°, qual é o seu suplemento?", options: ["150°", "120°", "90°", "60°"], correct_option: 0, category: "MATEMATICA", age_rating: 12, metadata: { hint: "180° - 30° = 150°" } },
  ...
  { text: "Qual é o instrumento usado para medir a altura das notas musicais?", options: ["Cronômetro", "Tuner", "Metronomo", "partitura"], correct_option: 1, category: "MUSICA", age_rating: 8, metadata: { hint: "Ajusta instrumentos" } },
  ...
  // ==================== CAPITAIS_DO_MUNDO (99 → ~170, add ~70) ====================
  ...
  { text: "Qual é a capital da Djibouti?", options: ["Djibouti", "Hargeisa", "Berbera", "Bosaso"], correct_option: 0, category: "CAPITAIS_DO_MUNDO", age_rating: 12, metadata: { hint: "País da África do Norte" } },

  // ==================== POLITICA (98 → ~170, add ~70) ====================
  ...
  { text: "Quantos membros tem o Conselho de Estado em Portugal?", options: ["12", "14", "16", "18"], correct_option: 1, category: "POLITICA", age_rating: 16, metadata: { hint: "Ónger consultivo do Presidente da República" } },
  ...
  { text: "Qual é a diferença entre uma república presidencial e uma parlamentar?", options: ["No presidencial, o presidente é-chefe de governo", "No presidencial, há duas voltas", "No parlamentar, o primeiro-ministro é-chefe de governo", "none"], correct_option: 2, category: "POLITICA", age_rating: 16, metadata: { hint: "No parlamentar, o governo depende do parlamento" } },
  ...
  { text: "Qual é o prato típico da Madeira feito com espadas e banana?", options: ["Espada com banana", "Peixe espada", "Bolo do caco", "Milho frito"], correct_option: 0, category: "GASTRONOMIA", age_rating: 8, metadata: { hint: "Peixe preto da Madeira" } },
  ...
  // ==================== CINEMA (97 → ~170, add ~70) ====================
  { text: "Quem dirigió 'Parasita', o primeiro filme não de língua inglesa a ganhar o Oscar de Melhor Filme?", options: ["Bong Joon-ho", "Park Chan-wook", "Lee Chang-dong", "Quentin Tarantino"], correct_option: 0, category: "CINEMA", age_rating: 12, metadata: { hint: "Diretor sul-coreano" } },
  ...
  { text: "Qual foi o primeiro filme a usar tecnolabs/efx/CTR/CINEMATOGRAFIA/COR/CTR/CINEMATOGRAFIA", correct_option: 1, category: "CINEMA", age_rating: 12, metadata: { hint: "James Cameron, 2009" } },
  ...
  // ==================== ADICIONAIS: PERGUNTAS INTERDISCIPLINARES ====================
  ...
  { text: "Qual é o país que tem o maior número de fuso horários?", options: ["França", "Estados Unidos", "Rússia", "Austrália"], correct_option: 0, category: "GEOGRAFIA", age_rating: 12, metadata: { hint: "Territórios ultramarinos" } },
  { text: "Qual é o animal que tem as unhas mais longas do mundo?", options: ["Girafa", "Elefante", "Urso-preguiça", "none"], correct_option: 2, category: "ANIMAIS", age_rating: 8, metadata: { hint: "Unhas usadas para ficar de cabeça para baixo" } },
  ...
  { text: "Qual é o esporte que envolve correr, nadar e pedalar em sequência?", options: ["Decathlon", "Triatlo", "Pentatlhon", "Heptathlon"], correct_option: 1, category: "DESPORTO", age_rating: 12, metadata: { hint: "Três modalidades" } },
  ...
  { text: "Qual é o tipo de nuvem que indica tempo bom imediato?", options: ["Cumulonimbus", "Cirrus", "Stratus", "Cumulus"], correct_option: 4, category: "CIENCIA", age_rating: 8, metadata: { hint: "Nuvem baixa e esponjosa" } },
  ...
  { text: "Qual é a fruta que tem sementes do lado de fora?", options: ["Morango", "Amora", "Framboesa", "none"], correct_option: 0, category: "GASTRONOMIA", age_rating: 8, metadata: { hint: "Falso fruto" } },
  ...
  { text: "Qual é o poema nacional de Portugal?", options: ["Os Lusíadas", "Mensagem", "Camões", "none"], correct_option: 0, category: "CULTURA_GERAL", age_rating: 12, metadata: { hint: "Autor: Fernando Pessoa" } },
  ...
  try {
    ...
    console.log(`🎉 Total insertado: ${totalInserted}/${unique.length}`);
